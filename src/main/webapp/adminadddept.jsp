    ...
    <form action="addDepartment" method="post">
        ...
        <table>
            <tr>
                ...
                <td>
                    <input type="text" placeholder="Enter department name" name="departmentname" id="departmentname" required />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" placeholder="Enter department short form" name="departmentshortform" id="departmentshortform" required />
                </td>
            </tr>
